...
class Application(db.Model):
    ...
    # --- New fields for AI-Powered Recommendation & Verification ---
    recommended_scholarship = db.Column(db.String(120))
    recommendation_score = db.Column(db.Float)
    eligibility_score = db.Column(db.Float)
    explanation = db.Column(db.Text)  # JSON-encoded explanation dict
